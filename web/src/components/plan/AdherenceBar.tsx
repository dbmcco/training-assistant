  ...
  return (
    <div className="rounded-xl bg-gray-900 border border-gray-800 p-4">
      <div className="flex items-center justify-between mb-2">
        ...
        <span className="text-sm font-bold text-gray-100">{pct}%</span>
      </div>
      ...
      <div className="flex items-center gap-4 mt-2 text-xs text-gray-500">
        <span>
          <span className="text-green-400 font-medium">{adherence.completed}</span> completed
        </span>
        <span>
          <span className="text-red-400 font-medium">{adherence.missed}</span> missed
        </span>
        <span>
          <span className="text-gray-400 font-medium">{adherence.total}</span> total
        </span>
      </div>
    </div>
  )
